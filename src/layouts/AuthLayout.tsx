...
const AuthLayout = () => {
  return (
    <div className={`min-h-screen flex items-center justify-center bg-[#707070] text-sm bg-cover bg-center grayscale-32`} style={{ backgroundImage: `url(${process.env.PUBLIC_URL || ""}/assets/images/bg-horizontal.jpg)` }}>
