        ...
        <Form name="layout-multiple-horizontal" layout="horizontal">
          ...
          <Row className="justify-center" gutter={16}>
            ...
            <Col span={8} offset={2}>
              <Form.Item
                layout="vertical"
                label="Có người phụ thuộc hay không"
                name="debt"
                rules={[{ required: true }]}
              >
                <Select
          ...
          <Row className="justify-center" gutter={16}>
            <Col span={8}>
              <Form.Item
                layout="vertical"
                label="Có vay thế chấp hay không"
                name="vertical"
                rules={[{ required: true }]}
              >
                <Select
            ...
            <Col span={8} offset={2}>
              <Form.Item
                layout="vertical"
                label="Có tài khoản tiết kiệm hay không"
                name="vertical2"
                rules={[{ required: true }]}
              >
                <Select
          ...
          <Row className="" gutter={16}>
            <Col span={8} offset={3}>
              <Form.Item
                layout="vertical"
                label="Có thẻ tín dụng hay không"
                name="vertical"
                rules={[{ required: true }]}
              >
                <Select
